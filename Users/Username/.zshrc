...
alias prspec="echo 'Preparing parallel-tests databases...' && rails parallel:prepare RAILS_ENV=test && bundle exec parallel_rspec spec && retry-failed-specs"
...
alias coherent="cd ~/Documents/Git/Coherent && git status"
alias coherent2="cd ~/Documents/Git/Coherent-2/Coherent && git status"
